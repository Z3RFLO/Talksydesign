...
const SettingRow: React.FC<SettingRowProps> = ({ icon: Icon, label, sublabel, value, isLink, onClick }) => (
    <div
        onClick={onClick}
...
const ToggleRow: React.FC<ToggleRowProps> = ({ icon: Icon, label, sublabel, isOn, onClick, disabled }) => (
