...
import { Search, Send, MoreVertical, ArrowLeft, Image as ImageIcon, Smile } from 'lucide-react';
...
export default function Messages() {
  ...
  const activeMessages = chats[selectedId] || [];
            ...
            <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-3">
               {activeMessages.map(msg => (
                 <div key={msg.id} className={`flex ${msg.sender === 'me' ? 'justify-end' : 'justify-start'}`}>
                   <div className={`max-w-[70%] px-5 py-3.5 rounded-[22px] text-[1.05rem] leading-relaxed ${
                     msg.sender === 'me' 
