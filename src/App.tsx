...
import TopicFeed from './pages/TopicFeed.tsx';
import Profile from './pages/Profile.tsx';
import Messages from './pages/Messages.tsx';
import PostDetails from './pages/PostDetails.tsx';
import UserPopup from './components/UserPopup.tsx';
import Settings from './pages/Settings.tsx';
import LiveBackground from './components/LiveBackground.tsx';
import { Post, User } from './types';

// --- INITIAL DATA ---
// We cast this to Post[] or let inference handle it, but for strictness we can type it.
...
export default function App() {
    ...
    const [viewingUser, setViewingUser] = useState<User | Post | null>(null); // For User Popup
    ...
    const handleNewPost = (text: string, tags: string[], options?: { isBoosted?: boolean }) => {
        const newPost: Post = {
            id: Date.now(),
    ...
    const handleUserClick = (userOrPost: User | Post) => {
        setViewingUser(userOrPost);
    };
    ...
    return (
        <div className="min-h-screen flex justify-center relative overflow-hidden">
            ...
            {/* SIDEBAR - Added props explicitly although not required if strictly typed in Sidebar */}
